class RegistriesController < ApplicationController
  ...
  private
    ...
    def registry_params
      params.require(:registry).permit(:registration_number, :issue_number, :teacher_id, :city, :date, :reason, :gas, :toll_booth, :travel_expenses, :land_passage, :air_ticket, :exit_transportation, :return_transportation, :requisition_number)
    end
end
