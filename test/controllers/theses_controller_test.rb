...
class ThesesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thesis" do
    assert_difference('Thesis.count') do
      post theses_url, params: { thesis: { admission_date: @thesis.admission_date, exit_date: @thesis.exit_date, student_id: @thesis.student_id, title: @thesis.title } }
    end
  ...
  test "should update thesis" do
    patch thesis_url(@thesis), params: { thesis: { admission_date: @thesis.admission_date, exit_date: @thesis.exit_date, student_id: @thesis.student_id, title: @thesis.title } }
