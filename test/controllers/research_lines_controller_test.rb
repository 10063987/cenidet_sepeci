...
class ResearchLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create research_line" do
    assert_difference('ResearchLine.count') do
      post research_lines_url, params: { research_line: { department_id: @research_line.department_id, line_coordinator: @research_line.line_coordinator, name: @research_line.name } }
    end
  ...
  test "should update research_line" do
    patch research_line_url(@research_line), params: { research_line: { department_id: @research_line.department_id, line_coordinator: @research_line.line_coordinator, name: @research_line.name } }
